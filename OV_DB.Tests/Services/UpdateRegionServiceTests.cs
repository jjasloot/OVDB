...
{
    public class UpdateRegionServiceTests : IDisposable
    {
        ...
        public UpdateRegionServiceTests()
        {
        ...
        {
            // Arrange
            var service = new UpdateRegionService(_serviceProvider, _hubContextMock.Object);
