...
namespace OV_DB.Helpers
{
    public static class GpxNamespaces
    {
        ...
        public const string OVDB_EXTENSIONS_NAMESPACE = "https://ovdb.infinityx.nl/gpx/extension";
    }
    ...
    public class GpxTrackPoint : GpxPoint
    {
        ...
        {
            get { return RouteType != null || FirstDateTime != null; }
        }
        ...
        public bool HasExtensions
        {
            get { return HasGarminExtensions || HasGarminTrackpointExtensionsV1 || HasGarminTrackpointExtensionsV2 || HasOVDBProperties; }
        }
    }
