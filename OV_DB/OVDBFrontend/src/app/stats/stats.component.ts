...
@Component({
  ...
  imports: [MatTabsModule, TimeStatsComponent, TranslateModule, UsedOperatorsComponent, RegionStatComponent, PunctualityStatsComponent, YearInReviewComponent, StationCompletionComponent],
